...
all the neighbors
			If next.visited == false && next.state != obs	//once we find the next unvisited node that isnÃ¢â‚¬â„¢t an 
obstacle
...
node and it isnÃ¢â‚¬â„¢t the start
If node.state != end 		//if it isnÃ¢â‚¬â„¢t the end node
